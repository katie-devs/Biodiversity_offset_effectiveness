...
# Randomm: create a random number, classify by percentile within both tr and cont, keep 10% of the observations each time
# Structure:exclude 10% top and bottom of each var
